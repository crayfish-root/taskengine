...
export async function POST(req: NextRequest) {
  ...
  // Deliberately open: attaching a file is a contributory, informational action —
  // matches the same "anyone can flag/contribute" reasoning as raising a blocker.
  // Visibility of the resulting document is still governed by canViewDocument.
  if (projectId) {
